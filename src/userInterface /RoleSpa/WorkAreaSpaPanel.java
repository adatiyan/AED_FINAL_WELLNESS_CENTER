 ...
 */
public class WorkAreaSpaPanel extends javax.swing.JPanel {

    /**
     * Creates new form WorkAreaSpaPanel
     */
    ...
    public WorkAreaSpaPanel(JPanel userProcessContainer, UserAcc account, Organization organization, Enterprise enterprise, EcoSystem system, Network sourceNetwork) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(Valuelbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(258, 57, 136, 17));
        ...
        add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(103, 122, 537, 158));

        Organizationlbl.setFont(new java.awt.Font("Helvetica Neue", 0, 18)); // NOI18N
        Organizationlbl.setText("ORGANIZATION");
        add(Organizationlbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 57, -1, -1));
        ...
        add(Assignbtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(646, 122, 141, 40));
        ...
        add(Processbtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(646, 180, 141, 43));
        ...
        add(Declinebtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(646, 238, 141, 42));
...
public void populateRequestTable(){
        ...
        model.setRowCount(0);
        for (FlowReq request : spaorganization.getWorkQueue().getflowReqList()){
