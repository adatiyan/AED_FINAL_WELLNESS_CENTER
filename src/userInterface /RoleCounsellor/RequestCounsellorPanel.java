 ...
 */
public class RequestCounsellorPanel extends javax.swing.JPanel {

    /**
     * Creates new form RoleCounsellor
     */
    ...
    public RequestCounsellorPanel(JPanel userProcessContainer, UserAcc account, Enterprise enterprise, EcoSystem system, Network sourceNetwork, Network targetNetwork) {
        initComponents();
    ...
    public RequestCounsellorPanel(JFrame userProcessContainer, UserAcc userAcc, Enterprise enterprise, EcoSystem system, Network sourceNetwork, Network network) {
    ...
    private void initComponents() {
        ...
        RequestCounsellorbtn = new javax.swing.JButton();
        ...
        add(Enterpriselbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(139, 455, -1, -1));

        Messagelbl.setFont(new java.awt.Font("Avenir", 0, 13)); // NOI18N
        Messagelbl.setText("Add message text:");
        add(Messagelbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(91, 527, -1, -1));
        ...
        add(Messagetxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(207, 527, 191, 45));

        RequestCounsellorbtn.setBackground(new java.awt.Color(178, 189, 155));
        RequestCounsellorbtn.setFont(new java.awt.Font("Avenir", 0, 13)); // NOI18N
        RequestCounsellorbtn.setText("Book Appointment");
        RequestCounsellorbtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                RequestCounsellorbtnActionPerformed(evt);
            }
        });
        add(RequestCounsellorbtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(626, 600, 159, 38));

        Valuelbl.setFont(new java.awt.Font("Avenir", 0, 13)); // NOI18N
        Valuelbl.setText("-");
        add(Valuelbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(207, 455, -1, -1));
        ...
        add(Backbtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(62, 29, -1, -1));
    ...
    private void RequestCounsellorbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RequestCounsellorbtnActionPerformed
        // TODO add your handling code here:
        String message = Messagetxt.getText();
        if (!message.isEmpty()) {
            CounsellorFlowReq request = new CounsellorFlowReq();
            ...
            if (sourceNetwork != targetNetwork) {
                for (Enterprise enterprise : targetNetwork.getEnterpriseDirectory().getEnterpriseList()) {
                    ...
                    for (Organization organization : enterprise.getOrganizationDirectory().getOrganizationList()) {
                        if (organization instanceof CounsellorOrganization) {
                            org = organization;
                            break;
                        }
                    }
    ...
    }//GEN-LAST:event_RequestCounsellorbtnActionPerformed
    ...
    private javax.swing.JButton RequestCounsellorbtn;
